...
QT_MOC_LITERAL(1, 7, 8), // "GetImage"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 5) // "image"

    },
    "ffmpeg\0GetImage\0\0image"
};
...
void ffmpeg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ffmpeg::*)(const QImage & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ffmpeg::GetImage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ffmpeg::GetImage(const QImage & _t1)
{
