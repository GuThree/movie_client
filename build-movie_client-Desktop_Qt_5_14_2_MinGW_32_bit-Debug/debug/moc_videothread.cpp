...
#include <memory>
#include "../../movie_client/videothread.h"
...
QT_MOC_LITERAL(1, 12, 9), // "emitImage"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "VideoThread\0emitImage\0"
};
...
void VideoThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->emitImage((*reinterpret_cast< const QImage(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoThread::emitImage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VideoThread::emitImage(const QImage & _t1)
{
